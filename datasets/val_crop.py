...
raw_data = '/media/qisens/2tb1/python_projects/training_pr/Cascade-Rotated-RetinaNet/DOTA/test'
raw_images_dir = os.path.join(raw_data, 'images')
raw_label_dir = os.path.join(raw_data, 'labelTxt')

save_dir = '/media/qisens/2tb1/python_projects/training_pr/Cascade-Rotated-RetinaNet/DOTA/test/save'
...
for idx, img in enumerate(images):
    ...
    clip_image(img.strip('.png'), img_data, box, 500, 500)
